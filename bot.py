...
@app_commands.choices(
    ...
    language=[
        ...
        discord.app_commands.Choice(name="Catalan", value="ca"),
        discord.app_commands.Choice(name="Dutch", value="nl"),
        discord.app_commands.Choice(name="Arabic", value="ar"),
        discord.app_commands.Choice(name="Swedish", value="sv"),
        discord.app_commands.Choice(name="Italian", value="it"),
        discord.app_commands.Choice(name="Indonesian", value="id"),
        discord.app_commands.Choice(name="Hindi", value="hi"),
        discord.app_commands.Choice(name="Finnish", value="fi"),
        discord.app_commands.Choice(name="Vietnamese", value="vi"),
        discord.app_commands.Choice(name="Hebrew", value="he"),
        discord.app_commands.Choice(name="Ukrainian", value="uk"),
        discord.app_commands.Choice(name="Greek", value="el"),
        discord.app_commands.Choice(name="Malay", value="ms"),
        discord.app_commands.Choice(name="Czech", value="cs"),
        discord.app_commands.Choice(name="Romanian", value="ro"),
        discord.app_commands.Choice(name="Danish", value="da"),
        discord.app_commands.Choice(name="Hungarian", value="hu"),
        discord.app_commands.Choice(name="Tamil", value="ta"),
        discord.app_commands.Choice(name="Norwegian", value="no"),
        discord.app_commands.Choice(name="Thai", value="th"),
        discord.app_commands.Choice(name="Urdu", value="ur"),
        discord.app_commands.Choice(name="Croatian", value="hr"),
        discord.app_commands.Choice(name="Bulgarian", value="bg"),
        discord.app_commands.Choice(name="Lithuanian", value="lt"),
        discord.app_commands.Choice(name="Latin", value="la"),
        discord.app_commands.Choice(name="Māori", value="mi"),
        discord.app_commands.Choice(name="Malayalam", value="ml"),
        discord.app_commands.Choice(name="Welsh", value="cy"),
        discord.app_commands.Choice(name="Slovak", value="sk"),
        discord.app_commands.Choice(name="Telugu", value="te"),
        discord.app_commands.Choice(name="Persian", value="fa"),
        discord.app_commands.Choice(name="Latvian", value="lv"),
        discord.app_commands.Choice(name="Bengali", value="bn"),
        discord.app_commands.Choice(name="Serbian", value="sr"),
        discord.app_commands.Choice(name="Azerbaijani", value="az"),
        discord.app_commands.Choice(name="Slovenian", value="sl"),
        discord.app_commands.Choice(name="Kannada", value="kn"),
        discord.app_commands.Choice(name="Estonian", value="et"),
        discord.app_commands.Choice(name="Macedonian", value="mk"),
        discord.app_commands.Choice(name="Breton", value="br"),
        discord.app_commands.Choice(name="Basque", value="eu"),
        discord.app_commands.Choice(name="Icelandic", value="is"),
        discord.app_commands.Choice(name="Armenian", value="hy"),
        discord.app_commands.Choice(name="Nepali", value="ne"),
        discord.app_commands.Choice(name="Mongolian", value="mn"),
        discord.app_commands.Choice(name="Bosnian", value="bs"),
        discord.app_commands.Choice(name="Kazakh", value="kk"),
        discord.app_commands.Choice(name="Albanian", value="sq"),
        discord.app_commands.Choice(name="Swahili", value="sw"),
        discord.app_commands.Choice(name="Galician", value="gl"),
        discord.app_commands.Choice(name="Marathi", value="mr"),
        discord.app_commands.Choice(name="Panjabi", value="pa"),
        discord.app_commands.Choice(name="Sinhala", value="si"),
        discord.app_commands.Choice(name="Khmer", value="km"),
        discord.app_commands.Choice(name="Shona", value="sn"),
        discord.app_commands.Choice(name="Yoruba", value="yo"),
        discord.app_commands.Choice(name="Somali", value="so"),
        discord.app_commands.Choice(name="Afrikaans", value="af"),
        discord.app_commands.Choice(name="Occitan", value="oc"),
        discord.app_commands.Choice(name="Georgian", value="ka"),
        discord.app_commands.Choice(name="Belarusian", value="be"),
        discord.app_commands.Choice(name="Tajik", value="tg"),
        discord.app_commands.Choice(name="Sindhi", value="sd"),
        discord.app_commands.Choice(name="Gujarati", value="gu"),
        discord.app_commands.Choice(name="Amharic", value="am"),
        discord.app_commands.Choice(name="Yiddish", value="yi"),
        discord.app_commands.Choice(name="Lao", value="lo"),
        discord.app_commands.Choice(name="Uzbek", value="uz"),
        discord.app_commands.Choice(name="Faroese", value="fo"),
        discord.app_commands.Choice(name="Haitian", value="ht"),
        discord.app_commands.Choice(name="Pashto", value="ps"),
        discord.app_commands.Choice(name="Turkmen", value="tk"),
        discord.app_commands.Choice(name="Norwegian Nynorsk", value="nn"),
        discord.app_commands.Choice(name="Maltese", value="mt"),
        discord.app_commands.Choice(name="Sanskrit", value="sa"),
        discord.app_commands.Choice(name="Luxembourgish", value="lb"),
        discord.app_commands.Choice(name="Burmese", value="my"),
        discord.app_commands.Choice(name="Tibetan", value="bo"),
        discord.app_commands.Choice(name="Tagalog", value="tl"),
        discord.app_commands.Choice(name="Malagasy", value="mg"),
        discord.app_commands.Choice(name="Assamese", value="as"),
        discord.app_commands.Choice(name="Tatar", value="tt"),
        discord.app_commands.Choice(name="Hawaiian", value="haw"),
        discord.app_commands.Choice(name="Lingala", value="ln"),
        discord.app_commands.Choice(name="Hausa", value="ha"),
        discord.app_commands.Choice(name="Bashkir", value="ba"),
        discord.app_commands.Choice(name="jw", value="jw"),
